...
public class ImageCaptureActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTakePhoto = (Button) findViewById(R.id.btnTakePic);
...
//		startActivityForResult(intent, 0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO && resultCode == Activity.RESULT_OK) {
            findViewById(R.id.sendpic).setVisibility(View.VISIBLE);
            setPic();
...
//			}
    ...
    private class UploadTask extends AsyncTask<Bitmap, Void, String> {
        ...
        protected String doInBackground(Bitmap... bitmaps) {
            ...
            try {
                HttpPost httppost = new HttpPost("http://www.subratgyawali.com.np/api/?action=upload&id="+id); // server
                MultipartEntity reqEntity = new MultipartEntity();
                reqEntity.addPart("fileToUpload", System.currentTimeMillis() + ".jpg", in);
        ...
        protected void onPostExecute(String result) {
            ...
            dismissDialog(1);
            Toast.makeText(ImageCaptureActivity.this,"uploaded", Toast.LENGTH_LONG).show();
        }
    }
